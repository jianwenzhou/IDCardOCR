...
//        styledAttrs.recycle();
    ...
    protected Size calculateCameraFrameSize (List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        int calcWidth = 0;
        int calcHeight = 0;
        Log.e("OpenCV","surfaceWidth="+surfaceWidth+",surfaceHeight="+surfaceHeight);
        Log.e("OpenCV","mMaxWidth="+mMaxWidth+",mMaxHeight="+mMaxHeight);
        ...
        for (Object size : supportedSizes) {
            ...
            Log.e("OpenCV"," 当前设备可用的Camera尺寸：width="+width+",height="+height);
